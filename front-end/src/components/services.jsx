...
function Services() {
  ...
  const handleBookNow = (service) => {
    ...
    setCtaNotice({ type: 'book', service: service.title });
    window.location.href = 'tel:9328764024';
    window.open('https://wa.me/919328764024?text=Hi%2C%20I%20want%20to%20book%20' + encodeURIComponent(service.title), '_blank', 'noopener');
  };
